...
const sideProjects = [
  {
    title: 'Retail Sales Transaction Analysis',
    tech: ['Python', 'Outlier Detection','Fraud Analysis', 'Pandas', 'Numpy'],
    category: 'Structured Data',
    description: 'This project addresses critical financial integrity challenges in the retail fuel sector through advanced anomaly detection methodologies. By leveraging unsupervised machine learning techniques on high-volume transaction data, the analysis identifies patterns indicative of fraudulent activities, operational irregularities, and financial leakage.',
    link: 'https://github.com/netrialiarahmi/retail-sales/blob/main/Retail_Sales_Transaction_Analysis.ipynb',
  },
  {
  ...
  },
  {
    ...
    tech: ['Python','Forecasting','Trend Analysis','SARIMAX', 'ARIMA'],
    category: 'Structured Data',
  ...
  },
  {
    ...
    category: 'Unstructured Data-NLP',
  ...
  {
    title: 'KompasGPT',
    tech: ['Python','Apache Airflow', 'GPT', 'Transformers', 'pytorch'],
    category: 'Unstructured Data-NLP',
    description: 'The system aims to help readers quickly grasp complex topics without needing to read multiple articles, while preserving factual consistency with Kompas reporting.',
    link: 'https://github.com/netrialiarahmi/KompasGPT',
  },
  {
    title: 'Mental Health Chatbot',
    tech: ['Python','Classification','Bi-LSTM', 'RAG', 'Chatbot'],
    category: 'Unstructured Data-NLP',
  ...
  },
  {
    ...
    category: 'Unstructured Data-Computer Vision',
  ...
  },
  {
    ...
    tech: ['Python','Classification','MobileNetV2', 'Tensorflow', 'Neural Newtwok'],
    category: 'Unstructured Data-Computer Vision',
  ...
  },
  {
    ...
    tech: ['Python','RT-DETR', 'Object Detection', 'Roboflow', 'matplotlib'],
    category: 'Unstructured Data-Computer Vision',
